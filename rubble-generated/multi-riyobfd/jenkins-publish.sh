...
plan_hash="${plan_id#multi-}"
plan_title="${RUBBLE_PLAN_TITLE}"
...
default_pipeline_name() {
  ...
  sanitize_name "rubble-${timestamp}-${plan_hash:0:7}"
}
...
<flow-definition plugin="workflow-job">
  <actions/>
  <description>Managed by Rubble Jenkins publisher. This job is a one-shot SCM Pipeline for ${plan_title}.</description>
