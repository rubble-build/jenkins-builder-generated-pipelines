...
export RUBBLE_PLAN_ID='tfagkogbrwgn4fra5ytt4jabozu7lrt6jslw5pzrrauh6464cuoa-python3-glibc-3.13.13'
export RUBBLE_PLAN_TITLE='tfagkog-python3-glibc-3.13.13'
export RUBBLE_PLAN_NOTES='Rubble inventory bundles for:
tfagkogbrwgn4fra5ytt4jabozu7lrt6jslw5pzrrauh6464cuoa-python3-glibc-3.13.13'
declare -a rubble_roots=(

  'tfagkogbrwgn4fra5ytt4jabozu7lrt6jslw5pzrrauh6464cuoa-python3-glibc-3.13.13'

)
declare -A rubble_root_short_ids=() rubble_root_names=() rubble_root_bricks=()

rubble_root_short_ids['tfagkogbrwgn4fra5ytt4jabozu7lrt6jslw5pzrrauh6464cuoa-python3-glibc-3.13.13']='tfagkog-python3-glibc-3.13.13'
rubble_root_names['tfagkogbrwgn4fra5ytt4jabozu7lrt6jslw5pzrrauh6464cuoa-python3-glibc-3.13.13']='python3-glibc-3.13.13'
root_relative='store/tf/ag/brk-tfagkogbrwgn4fra5ytt4jabozu7lrt6jslw5pzrrauh6464cuoa-python3-glibc-3.13.13.brick'
rubble_root_bricks['tfagkogbrwgn4fra5ytt4jabozu7lrt6jslw5pzrrauh6464cuoa-python3-glibc-3.13.13']="${lifecycle_dir}/${root_relative}"
